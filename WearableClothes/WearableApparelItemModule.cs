    ...
    public class WearableApparelItem : MonoBehaviour
    {
        ...
        private IEnumerator EquipWardrobe(Creature creature, Item item)
        {
            ...
            if (creature.isPlayer)
            {
                ...
                {
                    ContainerData.Content wornContent = creature.equipment.GetWornContent(wardrobe.manikinWardrobeData.channels[index], wardrobe.manikinWardrobeData.layers[index]);
                    if (wornContent != null)
